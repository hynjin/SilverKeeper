...
public class receiveSilverData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        SilverVO silverVO=new SilverVO(Integer.parseInt(heartRate), Integer.parseInt(walkCount), 
        		Integer.parseInt(identifyNumber),Integer.parseInt(currentTime), Boolean.valueOf(checkMiBand).booleanValue());
        //Date.valueOf(currentTime), Boolean.valueOf(checkMiBand).booleanValue());
        ...
        try{
        	...
        	String db = "insert into silverData(heartRate,walkCount,identifyNumber,currentTime,connMiBand) values("+silverVO.toStringDB()+")";
