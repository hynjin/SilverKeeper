...
public class ViewData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        param2+="&heartRate="+hRate+"&walkCount="+wCount+"&currentTime="+(new SimpleDateFormat("yyyy-MM-dd-hh-mm-ss")).format(new Date(System.currentTimeMillis()))+"&connMiBand="+connMiBand;
        rs.execute(param1);
